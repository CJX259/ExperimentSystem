...
export async function addExperiment(uid: string, name: string, deadline: string) {
...
export async function updateExperiment(uid: string, id: string, name: string, deadline: string) {
